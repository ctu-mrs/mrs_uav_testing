...
export PROJECT_NAME=ss

# get path to script
SCRIPT_PATH="$( cd "$(dirname "$0")" ; pwd -P )"

# following commands will be executed first, in each window
pre_input="export UAV_NAME=uav53; export UAV_TYPE=f450"

# define commands
# 'name' 'command'
input=(
  'Rviz' "waitForRos; unset ROS_IP; roscd mrs_uav_testing; rosrun rviz rviz -d ${SCRIPT_PATH}/../rviz/summer_school.rviz
  "
  'RvizInterface' "waitForRos; unset ROS_IP; roslaunch mrs_rviz_plugins rviz_interface.launch
"
  'Nimbro' "waitForRos; export UAV_NAME=uav; roslaunch mrs_uav_general nimbro.launch
"
  'Model' "waitForRos; roslaunch mrs_rviz_plugins load_robot.launch
"
