...
private:
  ...
  typedef mrs_uav_testing::circle_flierConfig      DrsParams_t;
  typedef dynamic_reconfigure::Server<DrsParams_t> Drs_t;
  boost::shared_ptr<Drs_t>                         drs_;
  void                                             callbackDrs(mrs_uav_testing::circle_flierConfig& params, uint32_t level);
  DrsParams_t                                      params_;
...
void CircleFlier::callbackDrs(mrs_uav_testing::circle_flierConfig& params, [[maybe_unused]] uint32_t level) {
...
PLUGINLIB_EXPORT_CLASS(mrs_uav_testing::CircleFlier, nodelet::Nodelet)
